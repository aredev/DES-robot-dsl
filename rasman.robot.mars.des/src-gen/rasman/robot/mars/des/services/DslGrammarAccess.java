 ...
 */
package rasman.robot.mars.des.services;
...
public class DslGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class MissionElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "rasman.robot.mars.des.Dsl.Mission");
	...
	public class TaskElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "rasman.robot.mars.des.Dsl.Task");
		private final Group cGroup = (Group)rule.eContents().get(1);
		...
		private final RuleCall cActionActionsEnumRuleCall_3_1_0 = (RuleCall)cActionAssignment_3_1.eContents().get(0);
		private final Group cGroup_4 = (Group)cGroup.eContents().get(4);
		private final Keyword cForKeyword_4_0 = (Keyword)cGroup_4.eContents().get(0);
		private final Keyword cMaxKeyword_4_1 = (Keyword)cGroup_4.eContents().get(1);
		private final Assignment cNrOfTimesAssignment_4_2 = (Assignment)cGroup_4.eContents().get(2);
		private final RuleCall cNrOfTimesINTTerminalRuleCall_4_2_0 = (RuleCall)cNrOfTimesAssignment_4_2.eContents().get(0);
		private final Keyword cTimesKeyword_4_3 = (Keyword)cGroup_4.eContents().get(3);
		private final Group cGroup_5 = (Group)cGroup.eContents().get(5);
		private final Keyword cNotKeyword_5_0 = (Keyword)cGroup_5.eContents().get(0);
		private final Assignment cIgnoreBehaviorAssignment_5_1 = (Assignment)cGroup_5.eContents().get(1);
		private final RuleCall cIgnoreBehaviorIgnorablesParserRuleCall_5_1_0 = (RuleCall)cIgnoreBehaviorAssignment_5_1.eContents().get(0);
		private final Group cGroup_6 = (Group)cGroup.eContents().get(6);
		private final Keyword cExpiresAfterKeyword_6_0 = (Keyword)cGroup_6.eContents().get(0);
		private final Assignment cTimeAssignment_6_1 = (Assignment)cGroup_6.eContents().get(1);
		private final RuleCall cTimeINTTerminalRuleCall_6_1_0 = (RuleCall)cTimeAssignment_6_1.eContents().get(0);
		private final Assignment cTimeunitAssignment_6_2 = (Assignment)cGroup_6.eContents().get(2);
		private final RuleCall cTimeunitTimeUnitValueParserRuleCall_6_2_0 = (RuleCall)cTimeunitAssignment_6_2.eContents().get(0);
		...
		// * / Task:
		//	'Task:' name=ID ('Uses:' sensor=SensorType)? ('Do:' action+=Actions)+ ('For' 'Max:' nrOfTimes=INT 'Times')? ('Not:'
		//	ignoreBehavior=Ignorables)? ('ExpiresAfter:' time=INT timeunit=timeUnitValue)?;
		@Override public ParserRule getRule() { return rule; }
		...
		//Actions
		public RuleCall getActionActionsEnumRuleCall_3_1_0() { return cActionActionsEnumRuleCall_3_1_0; }
		
		//('For' 'Max:' nrOfTimes=INT 'Times')?
		...
		//'Max:'
		public Keyword getMaxKeyword_4_1() { return cMaxKeyword_4_1; }
		
		//nrOfTimes=INT
		public Assignment getNrOfTimesAssignment_4_2() { return cNrOfTimesAssignment_4_2; }
		
		//INT
		public RuleCall getNrOfTimesINTTerminalRuleCall_4_2_0() { return cNrOfTimesINTTerminalRuleCall_4_2_0; }
		
		//'Times'
		public Keyword getTimesKeyword_4_3() { return cTimesKeyword_4_3; }
		...
		public Assignment getIgnoreBehaviorAssignment_5_1() { return cIgnoreBehaviorAssignment_5_1; }
		
		//Ignorables
		public RuleCall getIgnoreBehaviorIgnorablesParserRuleCall_5_1_0() { return cIgnoreBehaviorIgnorablesParserRuleCall_5_1_0; }
		
		//('ExpiresAfter:' time=INT timeunit=timeUnitValue)?
		public Group getGroup_6() { return cGroup_6; }
		
		//'ExpiresAfter:'
		public Keyword getExpiresAfterKeyword_6_0() { return cExpiresAfterKeyword_6_0; }
		
		//time=INT
		public Assignment getTimeAssignment_6_1() { return cTimeAssignment_6_1; }
		
		//INT
		public RuleCall getTimeINTTerminalRuleCall_6_1_0() { return cTimeINTTerminalRuleCall_6_1_0; }
		
		//timeunit=timeUnitValue
		public Assignment getTimeunitAssignment_6_2() { return cTimeunitAssignment_6_2; }
		
		//timeUnitValue
		public RuleCall getTimeunitTimeUnitValueParserRuleCall_6_2_0() { return cTimeunitTimeUnitValueParserRuleCall_6_2_0; }
	}
	public class TimeUnitValueElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "rasman.robot.mars.des.Dsl.timeUnitValue");
		private final Assignment cUnitAssignment = (Assignment)rule.eContents().get(1);
		private final RuleCall cUnitTimeUnitEnumRuleCall_0 = (RuleCall)cUnitAssignment.eContents().get(0);
		...
		//timeUnit
		public RuleCall getUnitTimeUnitEnumRuleCall_0() { return cUnitTimeUnitEnumRuleCall_0; }
	}
	public class IgnorablesElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "rasman.robot.mars.des.Dsl.Ignorables");
	...
	public class SensorTypeElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "rasman.robot.mars.des.Dsl.SensorType");
	...
	public class ColorSensorElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "rasman.robot.mars.des.Dsl.ColorSensor");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
		private final Group cGroup_0 = (Group)cAlternatives.eContents().get(0);
		private final Keyword cColorSensorKeyword_0_0 = (Keyword)cGroup_0.eContents().get(0);
		private final Keyword cOnKeyword_0_1 = (Keyword)cGroup_0.eContents().get(1);
		private final Assignment cDistinctAssignment_0_2 = (Assignment)cGroup_0.eContents().get(2);
		private final Keyword cDistinctNewKeyword_0_2_0 = (Keyword)cDistinctAssignment_0_2.eContents().get(0);
		private final Keyword cDetectedColorKeyword_0_3 = (Keyword)cGroup_0.eContents().get(3);
		private final Keyword cIsKeyword_0_4 = (Keyword)cGroup_0.eContents().get(4);
		private final Assignment cKeyAssignment_0_5 = (Assignment)cGroup_0.eContents().get(5);
		private final RuleCall cKeyColorValueParserRuleCall_0_5_0 = (RuleCall)cKeyAssignment_0_5.eContents().get(0);
		private final Group cGroup_1 = (Group)cAlternatives.eContents().get(1);
		private final Keyword cColorSensorKeyword_1_0 = (Keyword)cGroup_1.eContents().get(0);
		private final Keyword cOnKeyword_1_1 = (Keyword)cGroup_1.eContents().get(1);
		private final Assignment cDistinctAssignment_1_2 = (Assignment)cGroup_1.eContents().get(2);
		private final Keyword cDistinctNewKeyword_1_2_0 = (Keyword)cDistinctAssignment_1_2.eContents().get(0);
		private final Keyword cDetectedColorsKeyword_1_3 = (Keyword)cGroup_1.eContents().get(3);
		private final Keyword cAreKeyword_1_4 = (Keyword)cGroup_1.eContents().get(4);
		private final Assignment cKeysAssignment_1_5 = (Assignment)cGroup_1.eContents().get(5);
		private final RuleCall cKeysColorValueParserRuleCall_1_5_0 = (RuleCall)cKeysAssignment_1_5.eContents().get(0);
		...
		//'ColorSensor' 'On' distinct?='New'? 'DetectedColor' 'is:' key=ColorValue | 'ColorSensor' 'On' distinct?='New'?
		//'DetectedColors' 'are:' keys+=ColorValue+
		public Alternatives getAlternatives() { return cAlternatives; }
		...
		//'ColorSensor'
		public Keyword getColorSensorKeyword_0_0() { return cColorSensorKeyword_0_0; }
		
		//'On'
		public Keyword getOnKeyword_0_1() { return cOnKeyword_0_1; }
		
		//distinct?='New'?
		public Assignment getDistinctAssignment_0_2() { return cDistinctAssignment_0_2; }
		
		//'New'
		public Keyword getDistinctNewKeyword_0_2_0() { return cDistinctNewKeyword_0_2_0; }
		
		//'DetectedColor'
		public Keyword getDetectedColorKeyword_0_3() { return cDetectedColorKeyword_0_3; }
		
		//'is:'
		public Keyword getIsKeyword_0_4() { return cIsKeyword_0_4; }
		
		//key=ColorValue
		public Assignment getKeyAssignment_0_5() { return cKeyAssignment_0_5; }
		
		//ColorValue
		public RuleCall getKeyColorValueParserRuleCall_0_5_0() { return cKeyColorValueParserRuleCall_0_5_0; }
		
		//'ColorSensor' 'On' distinct?='New'? 'DetectedColors' 'are:' keys+=ColorValue+
		public Group getGroup_1() { return cGroup_1; }
		
		//'ColorSensor'
		public Keyword getColorSensorKeyword_1_0() { return cColorSensorKeyword_1_0; }
		
		//'On'
		public Keyword getOnKeyword_1_1() { return cOnKeyword_1_1; }
		
		//distinct?='New'?
		public Assignment getDistinctAssignment_1_2() { return cDistinctAssignment_1_2; }
		
		//'New'
		public Keyword getDistinctNewKeyword_1_2_0() { return cDistinctNewKeyword_1_2_0; }
		
		//'DetectedColors'
		public Keyword getDetectedColorsKeyword_1_3() { return cDetectedColorsKeyword_1_3; }
		
		//'are:'
		public Keyword getAreKeyword_1_4() { return cAreKeyword_1_4; }
		
		//keys+=ColorValue+
		public Assignment getKeysAssignment_1_5() { return cKeysAssignment_1_5; }
		
		//ColorValue
		public RuleCall getKeysColorValueParserRuleCall_1_5_0() { return cKeysColorValueParserRuleCall_1_5_0; }
	}
	public class TouchSensorElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "rasman.robot.mars.des.Dsl.TouchSensor");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class UltrasonicSensorElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "rasman.robot.mars.des.Dsl.UltrasonicSensor");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class ColorValueElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "rasman.robot.mars.des.Dsl.ColorValue");
	...
	public class TimeUnitElements extends AbstractEnumRuleElementFinder {
		private final EnumRule rule = (EnumRule) GrammarUtil.findRuleForName(getGrammar(), "rasman.robot.mars.des.Dsl.timeUnit");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
		...
		private final EnumLiteralDeclaration cMILISECONDSEnumLiteralDeclaration_1 = (EnumLiteralDeclaration)cAlternatives.eContents().get(1);
		private final Keyword cMILISECONDSMsKeyword_1_0 = (Keyword)cMILISECONDSEnumLiteralDeclaration_1.eContents().get(0);
		...
		//MILISECONDS="ms"
		public EnumLiteralDeclaration getMILISECONDSEnumLiteralDeclaration_1() { return cMILISECONDSEnumLiteralDeclaration_1; }
		
		//"ms"
		public Keyword getMILISECONDSMsKeyword_1_0() { return cMILISECONDSMsKeyword_1_0; }
	}
	public class TouchSensorSidesElements extends AbstractEnumRuleElementFinder {
		private final EnumRule rule = (EnumRule) GrammarUtil.findRuleForName(getGrammar(), "rasman.robot.mars.des.Dsl.TouchSensorSides");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class ActionsElements extends AbstractEnumRuleElementFinder {
		private final EnumRule rule = (EnumRule) GrammarUtil.findRuleForName(getGrammar(), "rasman.robot.mars.des.Dsl.Actions");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class DirectionsElements extends AbstractEnumRuleElementFinder {
		private final EnumRule rule = (EnumRule) GrammarUtil.findRuleForName(getGrammar(), "rasman.robot.mars.des.Dsl.Directions");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class ColorsElements extends AbstractEnumRuleElementFinder {
		private final EnumRule rule = (EnumRule) GrammarUtil.findRuleForName(getGrammar(), "rasman.robot.mars.des.Dsl.Colors");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class CompareOperatorElements extends AbstractEnumRuleElementFinder {
		private final EnumRule rule = (EnumRule) GrammarUtil.findRuleForName(getGrammar(), "rasman.robot.mars.des.Dsl.CompareOperator");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public DslGrammarAccess(GrammarProvider grammarProvider,
		...
		this.tDECIMAL = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "rasman.robot.mars.des.Dsl.DECIMAL");
	...
	protected Grammar internalFindGrammar(GrammarProvider grammarProvider) {
		...
		while (grammar != null) {
			if ("rasman.robot.mars.des.Dsl".equals(grammar.getName())) {
				return grammar;
			}
